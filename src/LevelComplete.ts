module MyGame {
	...
	export class LevelComplete extends Phaser.State {
		...
		create() {
			...
			this.button = this.add.sprite(this.world.centerX+40, this.world.centerY-130, 'nextLevelButton')
			...
			console.log("level1 complete state")
		}
